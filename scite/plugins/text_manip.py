...
def importprintval():
    ScEditor.ReplaceSel("import sys; sys.path.append(r'C:\pydev\dev\downpoured_scite_editor\tools\python_printval'); from printval import *")

def useprintval():
    ScEditor.ReplaceSel("printval| ")
...
def DoCiInterfaces():
	...
	#~ IFoo -> CIPtr<IFoo> spiFoo;


#then: faster search/replae. pygrep.
